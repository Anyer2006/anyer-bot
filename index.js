...
const http = require('http'); // <--- Añadido para el servidor
...
http.createServer((req, res) => {
  ...
  res.write('AnyerBot esta operando correctamente en la nube.');
  res.end();
}).listen(port, () => {
  console.log(`\n🚀 [RENDER] Servidor detectado en puerto ${port}. Bot estabilizado.`);
});
